                                ...
                                <?php
                                    ...
                                    if (count($lista) > 0)
                                    {
                                        foreach ($lista as $tarea)
                                        {
                                            ...
                                            echo '<td>';
                                            echo '<a class="btn btn-sm btn-outline-primary ms-2" href="tarea.php?id=' . $tarea->getIdTarea() . '" role="button">Mostrar</a>';
                                            echo '<a class="btn btn-sm btn-outline-success ms-2" href="editaTareaForm.php?id=' . $tarea->getIdTarea() . '" role="button">Editar</a>';
                                            echo '<a class="btn btn-sm btn-outline-danger ms-2" href="borraTarea.php?id=' . $tarea->getIdTarea() . '" role="button">Borrar</a>';
                                            echo '</td>';
                                            echo '</tr>';
                                        }
                                    }
