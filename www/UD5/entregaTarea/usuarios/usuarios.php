                                ...
                                <?php
                                    ...
                                    if (count($lista) > 0)
                                    {
                                        foreach ($lista as $usuario)
                                        {
                                            ...
                                            echo '<a class="btn btn-sm btn-outline-success" href="editaUsuarioForm.php?id=' . $usuario->getIdUsuario() . '" role="button">Editar</a>';
                                            echo '<a class="btn btn-sm btn-outline-danger ms-2" href="borraUsuario.php?id=' . $usuario->getIdUsuario() . '" role="button">Borrar</a>';
                                            echo '</td>';
                                            echo '</tr>';
                                        }
                                    }
